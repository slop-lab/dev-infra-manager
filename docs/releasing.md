...
pnpm --filter @slop-lab/dim-plugin-external-url-contracts run pack:dry-run
pnpm --filter @slop-lab/dim-plugin-external-urls run pack:dry-run
pnpm --filter @slop-lab/dim-plugin-provider-dns-cloudflare run pack:dry-run
pnpm --filter @slop-lab/dim-plugin-ingress-external-url-caddy run pack:dry-run
...
pnpm --filter @slop-lab/dim-plugin-external-url-contracts run publish:package
pnpm --filter @slop-lab/dim-plugin-external-urls run publish:package
pnpm --filter @slop-lab/dim-plugin-provider-dns-cloudflare run publish:package
pnpm --filter @slop-lab/dim-plugin-ingress-external-url-caddy run publish:package
