...
uses that host-mode label, while `.github/workflows/ci.yml` runs the equivalent
gate directly on a GitHub-hosted Ubuntu VM. GitHub-only manual Sysbox and KVM
