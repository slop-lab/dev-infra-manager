...
bash verification/scripts/pack-local-packages.bash "$package_root" >/dev/null
...
DIM_BIN="$dim_bin" bash verification/scripts/container-project-smoke.bash
DIM_BIN="$dim_bin" bash verification/scripts/container-multi-repo-project-smoke.bash
